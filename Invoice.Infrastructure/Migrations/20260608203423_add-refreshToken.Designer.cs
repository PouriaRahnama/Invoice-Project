...
namespace Invoice.Infrastructure.Migrations
{
    ...
    [Migration("20260608203423_add-refreshToken")]
            ...
            modelBuilder.Entity("Invoice.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bc46bd09-de5a-4190-a178-2b10149998d3"),
                        ...
                        new
                        {
                            Id = new Guid("6ebb769f-3c8d-4513-a91b-a4ea32eaa0ba"),
            ...
            modelBuilder.Entity("Invoice.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8434eeac-ba08-42c7-8232-afe61ff20ac6"),
                        ...
                        new
                        {
                            Id = new Guid("039732df-ed4a-4ac9-8b2a-e56de947f1a1"),
